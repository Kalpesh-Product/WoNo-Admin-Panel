...
const assetUtilizationSeries = [{ name: "Asset Utilization", data: assetUtilizationData }];
...
const assetAvailabilityData = [
    { label: "Assigned Assets", value: ((assignedAssets / totalAssets) * 100).toFixed(1), count: assignedAssets },
    { label: "UnAssigned Assets", value: ((unassignedAssets / totalAssets) * 100).toFixed(1), count: unassignedAssets },
];
...
const physicalDigitalPieData = [
    { label: "Physical Assets", value: ((physicalAssets / totalAssets) * 100).toFixed(1), count: physicalAssets },
    { label: "Digital Assets", value: ((digitalAssets / totalAssets) * 100).toFixed(1), count: digitalAssets },
];
...
const totalDepartmentAssets = departmentWiseAssets.reduce((sum, dept) => sum + dept.value, 0);
...
export { assetUtilizationOptions, assetUtilizationSeries, assetAvailabilityData, assetAvailabilityOptions, physicalDigitalOptions, physicalDigitalPieData, departmentPieData, departmentPieOptions, assetCategoriesData, recentAssetsColumns, recentAssetsData }