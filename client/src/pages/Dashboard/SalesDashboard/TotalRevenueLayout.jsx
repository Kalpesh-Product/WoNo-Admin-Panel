...
const TotalRevenueLayout = () => {
  ...
  const tabs = [
    ...
    { label: "Co-Working", path: "assigned-assets" },
    { label: "Meetings", path: "approvals" },
    { label: "Virtual Office", path: "approvals" },
    { label: "Workations", path: "approvals" },
    { label: "Alt. Revenues", path: "approvals" },
  ];
